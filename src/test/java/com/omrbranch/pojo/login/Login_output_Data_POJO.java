...
public class Login_output_Data_POJO {
	  private int id;
	  ...
	  private ArrayList<UserRole_output_POJO> user_role;
		public int getId() {
			return id;
		}
		...
		public ArrayList<UserRole_output_POJO> getUser_role() {
			return user_role;
		}
		public void setUser_role(ArrayList<UserRole_output_POJO> user_role) {
